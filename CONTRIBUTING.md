...
- **Feature request** — start with the moment that annoyed you rather than the
  ...
  somewhere; "add a text box" does not.
...
A security problem goes through [SECURITY.md](SECURITY.md) instead.

## Pull requests

The application source is not in this repository, so there is no code to send a
...
Keep it plain and specific. Frustration is fine and often informative;
insults at anyone are not.
