...
**Threads that stay organised.** Group the sidebar by project folder, or let a small model read the thread *titles* (never the conversations) and propose named groups. Pin, rename, fork from any message, move to a project.
