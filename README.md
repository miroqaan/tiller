...
**Two engines, one window.** New conversations default to Codex, which appears first in the engine picker; you can choose Claude instead. Both get the same queue, steering, approvals, model and effort pickers, plan usage and notifications. A thread can be **carried to the other engine mid-conversation** and continue there.
